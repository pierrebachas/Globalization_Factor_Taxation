...
*** 5.1 Main analysius outputs, capital liberalization events

			* 5.1.1 Joint ES graphs
			{
				cd "$usedata/synthetic_ES_intermediat_data/cap_lib_events"
				use lg_open, clear
				{
				local v lg_open
				{
				...
				***
				...
				cd "$outputs/capital_lib_events/es_graphs"
				...
				***
				...
				local xtitle "xtitle("Years to/from Event", margin(med) size(medlarge))"
				local ytitle "ytitle("Value Added, Corporate Sector", margin(med) size(medlarge))"
			...
			* 5.1.2 Table
			{
				...
				esttab pt_lg_open pt_lg_eq pt_Ksh_ndp pt_Ksh_corp pt_ETR_K_prime pt_ETR_L_prime ///
						using synth_post_treat_cap_events.tex ///
