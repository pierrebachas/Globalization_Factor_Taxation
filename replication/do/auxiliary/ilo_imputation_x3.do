*ilo_imputation_x3: coefficients (ratio of salary, to salary of employees) for selfemployed_ employers vs. ownaccount vs. family
...
foreach var in $x3 {
		preserve
						...
						xtregar log_`var' log_nnipc log_selfemployed_employers log_selfemployed_ownaccount log_selfemployed_family, re twostep
					// Store parameters
						local rho = e(rho_ar)
