...
local var="$var"
		...
		* 3.3 Imputation method
		...
		eststo imp_`var': did_imputation `var' id year tyear
		}
		****
		...
		keep est_`var' est_es_`var' rel_year est_pval_`var' avg_`var'_t avg_`var'_nt _est_pt_`var' ///
				_est_es_`var' se_es_`var' cilow4 ciup4 septboot_`var' _est_imp_`var' fstat_`var'
				
		cd "$usedata"
		save "synthetic_ES_intermediat_data/different_weights/`var'.dta", replace
